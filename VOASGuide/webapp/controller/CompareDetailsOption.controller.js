						...
						if (CDO_controller.getView().getModel("TblModel")) {
							...
							for (var i = 0; i < dtCol.length; i++) {
								...
								if (dtCol[i].NETPRICE != undefined && dtCol[i].NETPRICE != null && !isNaN(dtCol[i].NETPRICE) && dtCol[i].NETPRICE != "") {
									...
									var tblModelExt = new sap.ui.model.json.JSONModel(); tblModelExt.setData({
										columns: aColumnData,
										rows: dataExterior
									});
									var tblModelInt = new sap.ui.model.json.JSONModel(); tblModelInt.setData({
										columns: aColumnData,
										rows: dataInterior
									});
									var tblModelPwr = new sap.ui.model.json.JSONModel(); tblModelPwr.setData({
										columns: aColumnData,
										rows: dataPwr
									});
									var tblModelInfo = new sap.ui.model.json.JSONModel(); tblModelInfo.setData({
										columns: aColumnData,
										rows: dataInfo
									});
									var tblModelSaf = new sap.ui.model.json.JSONModel(); tblModelSaf.setData({
										columns: aColumnData,
										rows: dataSafety
									});

									var tblModelCol = new sap.ui.model.json.JSONModel(); tblModelCol.setData({
										columns: aColumnDataCol,
										rows: dataColour
									});
									var tblModelOpt = new sap.ui.model.json.JSONModel(dtOpt); CDO_controller.getView().setModel(tblModelOpt, "tblModelOpt");
									/*	tblModelOpt.setData({
											columns: aColumnDataOpt,
											rows: dataOpt
										});*/
									var tblModelDim = new sap.ui.model.json.JSONModel(); tblModelDim.setData({
										columns: aColumnData,
										rows: dataDim
									});
									var tblModelApx = new sap.ui.model.json.JSONModel(); tblModelApx.setData({
										columns: aColumnData,
										rows: dataApx
									});

									var tblExterior = CDO_controller.getView().byId("tblExterior"); tblExterior.setModel(tblModelExt); tblExterior.bindAggregation(
										"columns", "/columns",
									...
									var tblInterior = CDO_controller.getView().byId("tblInterior"); tblInterior.setModel(tblModelInt); tblInterior.bindAggregation(
										"columns", "/columns",
										function (index, context) {
											return new sap.m.Column({
												header: new sap.m.Label({
									...
									var tblPowertrain = CDO_controller.getView().byId("pwrTrn"); tblPowertrain.setModel(tblModelPwr); tblPowertrain.bindAggregation(
										"columns", "/columns",
										function (index, context) {
									...
									var tblSafety = CDO_controller.getView().byId("tblSafety"); tblSafety.setModel(tblModelSaf); tblSafety.bindAggregation(
										"columns", "/columns",
										function (index, context) {
											return new sap.m.Column({
												header: new sap.m.Label({
									...
									var tblInfotainment = CDO_controller.getView().byId("tblInfotainment"); tblInfotainment.setModel(tblModelInfo); tblInfotainment
									...
									var tblColorOptions = CDO_controller.getView().byId("tblColorOptions"); tblColorOptions.setModel(tblModelCol); tblColorOptions
									.bindAggregation("columns", "/columns", function (index, context) {
										return new sap.m.Column({
											header: new sap.m.Label({
												text: context.getObject().Vehicle
									...
									var tblDimensions = CDO_controller.getView().byId("tblDimensions"); tblDimensions.setModel(tblModelDim); tblDimensions.bindAggregation(
										"columns", "/columns",
										function (index, context) {
											return new sap.m.Column({
												header: new sap.m.Label({
									...
									var tblOptionPack = CDO_controller.getView().byId("tblOptionPackStat"); tblOptionPack.setModel("tblModelOpt");
									...
									var tblAPX = CDO_controller.getView().byId("tblAPX"); tblAPX.setModel(tblModelApx); tblAPX.bindAggregation("columns",
										"/columns",
										function (index, context) {
											return new sap.m.Column({
												header: new sap.m.Label({
