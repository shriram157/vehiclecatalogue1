						...
						if (brandCB != undefined && moYearCB != undefined && seriesCB != undefined) {
							...
							$.ajax({
								...
								success: function (data, textStatus, jqXHR) {
									...
									CreateWalkUpDialogController.getView().byId("idWalk_seriesCB").setSelectedKey(seriesVal);
								},
   ...
   else
{
 ...
 link.href = url1;
   	...
   	URL.revokeObjectURL(url1);
						...
						oBusyDialog.close();
						sap.m.MessageBox.show("No File exists for curent selection.", sap.m.MessageBox.Icon.ERROR, "Error", sap.m.MessageBox.Action.OK, null,
							null);
				...
				error: function (jqXHR, textStatus, errorThrown) {
					oBusyDialog.close();
					sap.m.MessageBox.show("Error occurred while fetching data. Please try again later.", sap.m.MessageBox.Icon.ERROR, "Error", sap.m.MessageBox
						.Action.OK, null, null);
				}
