sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.toyota-canada.vehiclesGuideV3.controller.CreateVehicleGuideDialog", {
		constructor: function (oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.toyota-canada.vehiclesGuideV3.view.CreateVehicleGuideDialog",
				this);
			this._bInit = false;
		},
		...
		_onButtonPress: function (oEvent) {
			...
			return new Promise(function (fnResolve) {
				...
				.then(function (result) {
					alert("This should Generate and display VOAS Pdf in new window");
